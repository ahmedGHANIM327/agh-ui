...
import type { ThemeName, SwitchVariant, TabsVariant, AccordionVariant, StepperDirection } from '@aghanim1206/ui-react';
```
...
<Accordion defaultValue="item-1" variant="default">
  ...
  <AccordionItem value="item-2">
    ...
    <AccordionContent>Yes — keyboard navigation and ARIA are built in.</AccordionContent>
  </AccordionItem>
</Accordion>
...
```tsx
// Horizontal — dot/check badges (default)
...
> The connector line turns **primary** once the next step is reached. RTL is supported automatically via `dir="rtl"`.
